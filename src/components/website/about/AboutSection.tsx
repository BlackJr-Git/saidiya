    ...
    <div className="container py-16 space-y-24 mx-auto">
      ...
      <div className="flex flex-col items-center text-center space-y-6">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl">
          Une plateforme innovante dédiée à la promotion et au financement de
          projets culturels africains.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Fondée en 2025, Saidiya est née d&apos;une passion commune pour
            l&apos;art et la culture africaine. Nos fondateurs, ayant constaté
            le manque de visibilité et de financement pour les projets culturels
            africains, ont décidé de créer une plateforme qui comblerait ce
            vide.
          </p>
          <p className="text-lg text-muted-foreground">
            Le nom &quot;Saidiya&quot; vient du swahili et signifie
            &quot;aider&quot; ou &quot;assister&quot;, ce qui reflète
            parfaitement notre mission d&apos;accompagner les artistes et
            porteurs de projets culturels dans leur développement.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1 space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Saidiya a pour mission de démocratiser l&apos;accès au financement
            pour les projets culturels africains, tout en leur offrant une
            visibilité internationale.
          </p>
          <p className="text-lg text-muted-foreground">
            Nous croyons fermement que l&apos;art et la culture sont des
            vecteurs essentiels de développement économique et social, et nous
            nous engageons à soutenir les initiatives qui valorisent le
      ...
      <div className="space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Nous collaborons avec des organisations qui partagent notre vision
      ...
      <div className="bg-primary/5 p-8 md:p-12 rounded-xl text-center space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Que vous soyez un artiste à la recherche de financement, un passionné
          d&#39;art africain ou simplement curieux, il y a une place pour vous
